...
/**
 * <p>Injectable to provide the following to {@link OpenIDRoleProvider}:</p>
 * <ul>
 ...
 * @since 0.0.1
 */
class OpenIDRoleInjectable<T> extends AbstractHttpContextInjectable<T> {

  private static final Log LOG = Log.forClass(OpenIDRoleInjectable.class);
   ...
   */
  OpenIDRoleInjectable(
    Authenticator<OpenIDRoleCredentials, T> authenticator,
    String realm,
  ...
  public Authenticator<OpenIDRoleCredentials, T> getAuthenticator() {
  ...
  public T getValue(HttpContext httpContext) {
    ...
    try {
      ...
      if (sessionId != null) {
        ...
        final OpenIDRoleCredentials credentials = new OpenIDRoleCredentials(sessionId, requiredAuthorities);
      ...
      OpenIDRoleProvider.LOG.debug(e, "Error decoding credentials");
    } catch (AuthenticationException e) {
      OpenIDRoleProvider.LOG.warn(e, "Error authenticating credentials");
